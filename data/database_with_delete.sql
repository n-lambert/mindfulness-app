...
43	11	2022-07-18	            Demonstrating a user inputting a survey with a bad day
44	11	2022-07-18	            Demonstrating bad day. lets hope this works.
\.
...
SELECT pg_catalog.setval('public.journal_responses_journal_response_id_seq', 44, true);
...
SELECT pg_catalog.setval('public.survey_answers_survey_answer_id_seq', 46, true);
